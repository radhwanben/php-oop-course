    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo $baseUrl; ?>index.php?page=magazines">Magazines</a></li>
                <li><a href="<?php echo $baseUrl; ?>index.php?page=writers">Writers</a></li>
                <li><a href="<?php echo $baseUrl; ?>index.php?page=articles&action=owners">Owners</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
