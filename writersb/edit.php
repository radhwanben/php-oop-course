                ...
                ?>
                    ...
                    <input type="hidden" name="id" value="<?php echo $data->id; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" placeholder="Email" name="email" required><?php echo $data->email; ?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" placeholder="Biography" name="biography" value="<?php echo $data->biography; ?>">
                        </div>
                      </div>
                      <div class="form-group">
