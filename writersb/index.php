...
<div class="container">
    <div class="row">
       ...
       if ($action == 'create') {
            require('writers/create.php');
        } elseif($action == 'store') {
            require('writers/store.php');
        } elseif($action == 'createMultiple') {
            require('writers/createMultiple.php');
        } elseif($action == 'storemultiple') {
            require('writers/storeMultiple.php');
        } elseif ($action == 'edit') {
            require('writers/edit.php');
        } elseif ($action == 'update') {
            require('writers/update.php');
        } elseif ($action == 'delete') {
            require('writers/delete.php');
        } elseif ($action == 'detail') {
            require('writers/detail.php');
        } else {
            require 'data.php';
        }
       ?>
