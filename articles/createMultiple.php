                ...
                <div class="panel-body">
                    ...
                    <h2 class="text-center">Article</h2>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <select class="form-control" id="magazine" name="magazine1">
                                <?php
                                ...
                                <label for="writesnames">magazine</label>
                                      <option value='<?php echo $writers->id;?>'><?php echo $writers->title  ?></option>
                                      <?php
                                      }
                                  ?>
                        </select>
                    ...
                    <h2 class="text-center">Article</h2>
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">Author</label>
                        <div class="col-sm-10">
                        <select class="form-control" id="magazine" name="magazine2">
                                <?php
